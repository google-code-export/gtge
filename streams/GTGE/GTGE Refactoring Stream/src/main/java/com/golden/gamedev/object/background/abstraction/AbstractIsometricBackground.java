 ...
 * perform the background tile rendering. <br />
 * <br />
 * As of 0.2.4, {@link AbstractIsometricBackground} extends
 * {@link BoundedBackground} directly.
 */
public abstract class AbstractIsometricBackground extends BoundedBackground {
	
	/**
	 * Serializable ID generated by Eclipse. If this class changes its internal
	 * structure, this will be replaced by 2L as it will be the second version
	 * of this class in terms of its structure.
	 */
	private static final long serialVersionUID = 1608748788737573394L;
