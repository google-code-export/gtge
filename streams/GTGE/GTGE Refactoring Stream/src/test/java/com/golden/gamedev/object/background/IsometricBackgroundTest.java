 ...
 * 
 */
public class IsometricBackgroundTest extends TestCase {
	
	private IsometricBackground background;
	
	protected void setUp() throws Exception {
		background = new IsometricBackground(new BufferedImage[] {
	...
	/**
	 * Test method for
	 * {@link com.golden.gamedev.object.background.IsometricBackground#setSize(int, int)}
	 * .
	 */
	...
	/**
	 * Test method for
	 * {@link com.golden.gamedev.object.background.IsometricBackground#renderTile(java.awt.Graphics2D, int, int, int, int)}
	 * .
	 */
	...
	/**
	 * Test method for
	 * {@link com.golden.gamedev.object.background.IsometricBackground#IsometricBackground(java.awt.image.BufferedImage[], int[][])}
	 * .
	 */
	...
	/**
	 * Test method for
	 * {@link com.golden.gamedev.object.background.IsometricBackground#IsometricBackground(java.awt.image.BufferedImage[], int, int)}
	 * .
	 */
	public void testTileBackgroundBufferedImageArrayIntInt() {
		background = new IsometricBackground(background.getTileImages(), 1, 1);
		assertNotNull(background);
	}
	
	/**
	 * Test method for
	 * {@link com.golden.gamedev.object.background.IsometricBackground#IsometricBackground(java.awt.image.BufferedImage[], int[][], int, int)}
	 * .
	 */
	public void testTileBackgroundBufferedImageArrayIntArrayArrayIntInt() {
		background = new IsometricBackground(background.getTileImages(),
		        background.getTiles(), 0, 0);
		assertNotNull(background);
	}
	
	/**
	 * Test method for
	 * {@link com.golden.gamedev.object.background.IsometricBackground#getTileImages()}
	 * .
	 */
	public void testGetTileImages() {
		...
		background.setTileImages(images, 0);
		assertEquals(images, background.getTileImages());
	}
	
	/**
	 * Test method for
	 * {@link com.golden.gamedev.object.background.IsometricBackground#setTileImages(java.awt.image.BufferedImage[])}
	 * .
	 */
	...
	/**
	 * Test method for
	 * {@link com.golden.gamedev.object.background.IsometricBackground#getTiles()}
	 * .
	 */
	...
	/**
	 * Test method for
	 * {@link com.golden.gamedev.object.background.IsometricBackground#setTiles(int[][])}
	 * .
	 */
	...
	public void setBackground(IsometricBackground background) {
